    ...
    <KBarPortal>
      <KBarPositioner className="z-50 select-none backdrop-blur bg-zinc-800/30 font-clash overflow-hidden">
        <KBarAnimator
          ...
          className="w-[90%] lg:w-[44%] md:w-2/3 overflow-hidden text-lg text-white bg-zinc-100 rounded-lg dark:bg-zinc-900 min-w-500 shadow-xl kbar"
        >
...
const ResultItem = React.forwardRef(
  (
    ...
    React.useEffect(() => {
      if (active && !wasActive.current) playSound('tick');
