      ...
      >
        <div className="flex flex-col gap-5">
          ...
          <p className="text-zinc-600 dark:text-zinc-400 max-w-2xl">
            Strongest fit: teams building real-time agents, LLM evaluation
            systems, AI guardrails, or developer-facing AI infrastructure where
            product quality and systems judgment both matter.
          </p>
