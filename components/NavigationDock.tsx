    ...
    <div className="pointer-events-auto flex w-full max-w-[25rem] flex-col items-center gap-2">
      ...
      >
        ...
        <DockButton
          ...
          toggleCue={moreOpen ? 'droplet' : 'bloom'}
        >
...
function DockButton({
  ...
  return (
    <motion.button
      ...
      aria-label={label}
      onClick={onClick}
      data-cuelume-silent={silent ? 'true' : undefined}
      data-cuelume-hover={silent ? undefined : hoverCue}
      data-cuelume-toggle={silent ? undefined : toggleCue}
      data-cuelume-press={silent || toggleCue ? undefined : 'press'}
      data-cuelume-release={silent || toggleCue ? undefined : 'release'}
