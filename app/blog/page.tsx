...
export const metadata: Metadata = {
  title: 'Blog',
  description:
    'Focused essays on AI engineering, hybrid search, ranking systems, real-time AI products, and the infrastructure behind them.',
  ...pageSocialMetadata({
    page: 'blogs',
    title: 'Blog',
    description:
...
export default function Blogs() {
  ...
  const years = Object.keys(archiveByYear).sort(
      ...
      <section className="flex flex-col w-full mt-16 lg:mt-0 gap-16 lg:gap-20 mb-20">
        <header className="flex flex-col gap-4 max-w-3xl">
          ...
          <p className="text-zinc-700 dark:text-zinc-400 leading-relaxed">
            Focused essays on the engineering work behind AI products: real-time
            systems, LLM evaluation, hybrid search, recommendations, ranking
            loops, and the infrastructure that keeps everything safe to scale.
          </p>
        </header>
