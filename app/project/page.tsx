      ...
      <section className="flex flex-col w-full mt-16 lg:mt-0 gap-10 mb-12">
        <div className="flex flex-col gap-3">
          ...
          <p className="dark:text-zinc-400 text-zinc-700 leading-relaxed max-w-2xl">
            A tighter shelf of projects I built to learn product, systems, and
            developer experience in public. Less filler here: open a project for
            the build story, constraints, and lessons.
          </p>
        </div>
...
function ProjectCard({ project }: { project: Project }) {
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          'relative w-full h-48 sm:h-56 rounded-xl overflow-hidden bg-zinc-100 dark:bg-zinc-900 ring-1',
          visual.image
        )}
      >
        <Image
