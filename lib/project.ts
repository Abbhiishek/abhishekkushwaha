...
export const projects: Project[] = [
    {
        ...
        description:
            "An open-source Electron app that turns a global shortcut into voice-to-text anywhere in Windows, with Azure OpenAI Whisper, optional AI cleanup, a personal dictionary, snippets, and local-first history.",
        judgment: "Desktop productivity - voice to cursor",
        stack: ["Electron", "JavaScript", "Azure OpenAI", "Whisper", "Windows"],
        image: "/vaaniflow.png",
        accent: "sky",
        layout: "utility-product",
        status: "shipped",
        period: "2026",
        githubUrl: "https://github.com/Abbhiishek/vaaniflow",
        liveUrl: "https://vaaniflow.vercel.app/",
        featured: true,
    },
    {
        slug: "pdf-kabootr",
